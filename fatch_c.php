...
$sql = " SELECT * FROM userhoushold WHERE 1; ";
...
?>
        ...
        <center><h1>User Houshold Information </h1></center>
        <table style="width:100%" border ="2">
            ...
            <tr>
                ...
                <td><?php echo $rows['houshold'];?></td>
                <td><?php echo $rows['totalland'];?></td>
                <td><?php echo $rows['electricity'];?></td>
                <td><?php echo $rows['electricitysupply'];?></td>
                <td><?php echo $rows['sourceofwater'];?></td>
